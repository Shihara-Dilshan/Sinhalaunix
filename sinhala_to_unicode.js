...
//specialCharUni[2]='්‍ර'; specialChar[2]='ra';
   console.log(consonants)
    console.log(consonantsUni)
    console.log(vowels)
    console.log(vowelsUni)
    console.log(vowelModifiersUni)
    console.log(specialConsonants)
    console.log(specialConsonantsUni)
    console.log(specialCharUni)
...
console.log(convertSinglishToUnicode('oo'));
